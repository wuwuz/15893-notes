...
Note that we first use the pseudorandomness of $G(s_R^v)$ to prove the pseudorandomness of $\CV_d$ and then use $r$'s randomness to prove $s_R^{v||0}$'s randomness, so there's enough randomness.}.
This means that 
given $(s_L, b_L, \CV_1, \ldots, \CV_{d-1})$, 
