...
The Private Information Retrieval problem was first introduced by Benny Chor, Eyal Kushilevitz, Oded Goldreich and Madhu Sudan~\cite{chor1998private}.
In this setting, we will have a client and server(s). The server(s) are connected to a public database indexed from $1$ to $n$, which could represent DNS, webpage, leaked password database, etc.
...
\begin{definition}[PIR - Single Server Scheme]
