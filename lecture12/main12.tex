...
cost per dictionary operation\footnote{In an AVL tree, not all operations
...
denoted ${\sf Pos}'_1, \ldots, {\sf Pos}'_D$.
Now, 
%repeat the following for $1.44 \log N$ times:
for $i = 1$ to $D$, repeat the  
following:
\begin{itemize} 
\item 
...
\begin{itemize}
\item 
If an element $(k', v, {\sf Pos}, {\sf ChildrenKeys}, {\sf ChildrenPos})$
is found, 
\item 
\end{itemize}
\end{itemize}
...
It is known that the maximum depth of an AVL
