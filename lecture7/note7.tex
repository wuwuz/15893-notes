...
$S \cdot T \geq \Omega(n)$. \elaine{TODO: modify the statement
based on proof}  
\label{thm:yaobox}
\end{theorem} 
...
%Initially, let ${\sf known} = \emptyset$.
    ...
    \begin{enumerate}[leftmargin=6mm]
        \item Seed the protocol with ${\sf coins}$, and 
...
\item 
lets $\known \impliedby \known \cup \{q_i\} \cup {\text{all boxes opened during query}}$
