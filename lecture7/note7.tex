...
\begin{claim}
%$\E[|G|] \geq 0.09/T$. 
$\Pr[|G| > 0.058n/T] \geq 0.48$ for sufficiently large $n$.
...
with probability at least $1 - \exp(-\Omega(n/T)) - 1/2$, 
$|G| \geq 0.09n/T - 0.032n/T = 0.058n/T$.
\end{proof}

\begin{claim}
With probability at least \elaine{FILL}, 
$|G_0| - |G_1| \geq 0.1\cdot n/T$.
\end{claim}
\begin{proof}
