...
\begin{itemize}
    ...
    \item Communication Bandwidth per Query: $O(\sqrt{n})$
...
This lower bound holds even for a scheme that supports 1 query, regardless of server space, bandwidth, and amount of preprocessing work. Before proceeding with the proof, we first have to discuss another slightly different problem called Yao's Box Problem \cite{yao}.
